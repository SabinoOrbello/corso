...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const currentCharacter = starWarsCharacters[i]; //serve a creare una variabile con all'interno tutte le proprieta di starcharacter
...
/* ESERCIZIO 7
  ...
  Se la massa è superiore a 700 stampa in console: "Ship is half loaded"
  Se la massa è superiore a 900 stampa in console: "Ship is half loaded"
